...
java -ea -Dcom.sun.management.jmxremote -Xss10000k -Xmx600M  -DentityExpansionLimit=1000000 -DelementAttributeLimit=1000000 -Djava.rmi.server.hostname=$hostname -jar $server --conf $conf 2>&1 <<EOF
